; ModuleID = 'OneArray.c'
source_filename = "OneArray.c"
target datalayout = "E-m:m-p:32:32-i8:8:32-i16:16:32-i64:64-n32-S64"
target triple = "mips"

; Function Attrs: mustprogress nofree norecurse nosync nounwind willreturn memory(argmem: read)
define dso_local i32 @add(ptr nocapture noundef readonly %0) local_unnamed_addr #0 {
...
define dso_local i32 @main() local_unnamed_addr #1 {
  ...
  %4 = getelementptr inbounds [10 x i32], ptr %2, i32 0, i32 2
  ...
  %7 = getelementptr inbounds [10 x i32], ptr %2, i32 0, i32 0
  %8 = call i32 @add(ptr noundef %7)
