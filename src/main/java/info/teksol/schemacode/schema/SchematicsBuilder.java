...
import info.teksol.schemacode.mindustry.BlockType;
import info.teksol.schemacode.mindustry.Icons;
...
public class SchematicsBuilder {
    ...
    public SchematicsBuilder( Consumer<CompilerMessage> messageListener, AstDefinitions astDefinitions, Path basePath) {
        this.messageListener = messageListener;
        this.astDefinitions = astDefinitions;
        this.basePath = basePath;
    }

    public static SchematicsBuilder create( AstDefinitions definitions,
            Consumer<CompilerMessage> messageListener, Path basePath) {
        return new SchematicsBuilder(messageListener, definitions, basePath);
    }
